...
class HttpUtil {
  ...
  HttpUtil._internal() {
    ...
    dio.interceptors.add(InterceptorsWrapper(
      onRequest: (options, handler) {
        ...
        if (options.baseUrl == BMOB_API_HOST) {
          options.headers.addAll(getBmobHeader());
        }
  ...
  /// 读取本地其他配置
  Map<String, dynamic> getBmobHeader() {
    var headers = <String, dynamic>{};
    headers['X-Bmob-Application-Id'] = BMOB_APPID;
    headers['X-Bmob-REST-API-Key'] = BMOB_APIKEY;
    return headers;
  }
